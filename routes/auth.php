...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['permission:company'], function () {
        ...
        Route::post('/corporate/advertisement', [CorporateController::class, 'CorporateAdvertisementPost'])->name('company.advertisement');
    });

    Route::group(['permission:admin'], function () {
        Route::get('/admin/setting', [AdminController::class, 'AdminSetting'])->name('admin.setting');
        Route::post('/admin/setting', [AdminController::class, 'AdminSettingPost'])->name('admin.setting');
        Route::get('/admin/distribution', [AdminController::class, 'AdminDistribution'])->name('admin.distribution');
        Route::post('/admin/distribution', [AdminController::class, 'AdminDistributionPost'])->name('admin.distribution');
        Route::get('/admin/advertisement/setting', [AdminController::class, 'AdminAdvertisementSetting'])->name('admin.advertisement.setting');
        Route::post('/admin/advertisement/setting', [AdminController::class, 'AdminAdvertisementSettingPost'])->name('admin.advertisement.setting');
        Route::get('/admin/advertisement/company/{id}', [AdminController::class, 'AdminAdvertisementEdit'])->name('admin.advertisement.edit');
        Route::post('/admin/advertisement/company/{id}', [AdminController::class, 'AdminAdvertisementEditPost'])->name('admin.advertisement.edit');
        Route::get('/admin/user/list', [AdminController::class, 'AdminUserList'])->name('admin.user.list');
        Route::post('/admin/user/list/{id}', [AdminController::class, 'AdminUserListPost'])->name('admin.user.list');
        Route::get('/admin/company_issue', [AdminController::class, 'AdminCompanyIssue'])->name('admin.company.issue');
        Route::post('/admin/company_issue', [AdminController::class, 'AdminCompanyIssuePost'])->name('admin.company.issue');
        ...
        Route::post('/admin/company/edit/{id}', [AdminController::class, 'AdminCompanyEditPost'])->name('admin.company.edit');
