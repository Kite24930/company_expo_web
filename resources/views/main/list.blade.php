<x-template title="企業一覧" css="main.css" :overview="$overview" :isAdmission="$is_admission">
    ...
    <div id="loading" class="bg-gray-700 bg-opacity-70 fixed z-[1000] w-full h-full top-0 bottom-0 left-0 right-0 flex justify-center items-center">
        <div class="flex flex-col items-center justify-center gap-4">
            ...
            <div class="load-text text-center w-[200px]">
                <p class="text-white text-center ml-3">Loading</p>
                                            ...
                                            @foreach($layout[$date->date][$period->period] as $company)
                                                <div class="flex flex-col items-center relative w-full max-w-[300px] rounded-lg shadow">
                                                    @if($one_word_pr[$company->company_id])
                                                        <div class="text-xs py-1 px-2 rounded absolute top-0 -left-2 z-20 -rotate-6 text-center shadow-lg" style="{{ __('background-color: '.$one_word_pr[$company->company_id]->background_color.'; color: '.$one_word_pr[$company->company_id]->text_color) }}">
