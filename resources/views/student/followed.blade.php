<x-template title="フォロー企業一覧" css="dashboard/student.css" :overview="$overview" :isAdmission="$is_admission">
    <main class="w-full min-h-screen flex flex-col items-center gap-4 p-2">
        <h1 class="text-title md:text-2xl text-xl">フォロー企業一覧</h1>
        <div class="text-sm">企業名をクリックすると企業詳細画面に移動できます。<br>フォロー企業への情報開示設定を変更できます。</div>
        <div class="p-4 bg-white rounded-lg border shadow max-w-lg">
