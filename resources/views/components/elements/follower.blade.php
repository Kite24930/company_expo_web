<div class="p-2 bg-white border rounded-lg flex flex-col md:min-w-[250px] min-w-full gap-2 {{ __('faculty-'.$student->student_faculty_id) }} {{ __('grade-'.$student->student_grade_id) }} @if($student->student_follow_disclosure === 1) public @endif follower">
    ...
    @if($student->student_follow_disclosure === 1)
        <div>
