<div {!! $attributes->merge(['class' => 'rounded-2xl bg-white border px-4 py-6 w-full']) !!}>
    ...
    <div class="inline-flex items-center mt-2 border-gray-300 rounded-md shadow-sm border p-2">
        <span class="me-3 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $leftText }}</span>
        ...
        <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $rightText }}</span>
    </div>
