...
const path_name = window.location.pathname.split('/')[0];
...
document.getElementById('company_name_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/company_name_edit?api_token=' + api_token, sendData)
        .then((res) => {
            if (res.data.success) {
...
document.getElementById('company_industry_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/company_industry_edit?api_token=' + api_token, sendData)
        .then((res) => {
            if (res.data.success) {
...
document.getElementById('company_logo_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/company_logo_edit?api_token=' + api_token, sendData)
        .then((res) => {
            if (res.data.success) {
...
document.getElementById('company_img_btn').addEventListener('click', () => {
    ...
    sendData.append('company_id', company_id);
    sendData.append('_token', csrf);
    axios.post(path_name + '/api/company_img_edit?api_token=' + api_token, sendData)
        .then((res) => {
            if (res.data.success) {
...
function toastUiEdit(target) {
    ...
    axios.post(path_name + '/api/' + target.id + '_edit?api_token=' + api_token, sendData)
        .then((res) => {
            if (res.data.success) {
...
document.getElementById('occupation-add').addEventListener('click', () => {
    ...
    axios.get(path_name + '/api/occupation_item_add?api_token=' + api_token + '&company_id=' + company_id + '&id=' + targetId)
        .then((res) => {
...
function occupationDelete(target) {
    ...
    if (targetId > 0) {
        axios.delete(path_name + '/api/occupation_item_delete/' + targetId + '?api_token=' + api_token)
            .then((res) => {
                console.log(res.data);
...
document.getElementById('occupation_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/occupation_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
document.getElementById('target_btn').addEventListener('click', () => {
    ...
    console.log(sendData);
    axios.post(path_name + '/api/target_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
document.getElementById('head_office_address_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/head_office_address_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
document.getElementById('established_at_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/established_at_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
document.getElementById('capital_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/capital_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
document.getElementById('sales_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/sales_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
document.getElementById('employees_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/employees_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
document.getElementById('mie_univ_ob_og_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/mie_univ_ob_og_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
document.getElementById('planned_number_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/planned_number_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
if (branchInsertHeadOfficeBtn) {
    document.getElementById('branch_insert_head_office_btn').addEventListener('click', () => {
        ...
        axios.post(path_name + '/api/branch_insert_head_office?api_token=' + api_token, sendData)
            .then((res) => {
                console.log(res.data);
                const parser = new DOMParser();
...
function branchOfficeDelete(target) {
    const targetId = Number(target.getAttribute('data-id'));
    if (targetId > 0) {
        axios.delete(path_name + '/api/branch_office_delete/' + targetId + '/' + company_id + '?api_token=' + api_token)
            .then((res) => {
                console.log(res.data);
...
document.getElementById('branch_office_add').addEventListener('click', () => {
    ...
    axios.get(path_name + '/api/branch_office_add/' + target + '?api_token=' + api_token)
        .then((res) => {
            console.log(res.data);
            const parser = new DOMParser();
            const insertPoint = document.getElementById('branch_office_body');
...
document.getElementById('branch_offices_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/branch_office_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
            const parser = new DOMParser();
            const insertPoint = document.getElementById('branch_office_body');
...
document.getElementById('recruit_in_charge_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/recruit_in_charge_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
...
document.getElementById('url_btn').addEventListener('click', () => {
    ...
    axios.post(path_name + '/api/url_edit?api_token=' + api_token, sendData)
        .then((res) => {
            console.log(res.data);
